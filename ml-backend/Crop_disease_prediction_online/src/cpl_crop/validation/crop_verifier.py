...
NON_LEAF_PROMPTS = [
    ...
    "a photograph of a keyboard",
    "a photograph of a person",
    "a photograph of a building",
    "a photograph of animate objects other than plants",
]
...
class CropVerifier:
    ...
    def __init__(
        ...
        logger.info(
            "CLIP ready (%d crop prompts, embed dim=%d)",
            len(self._crops),
            int(self._text_embeds.shape[-1]),
        )
