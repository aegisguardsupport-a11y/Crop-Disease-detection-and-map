...
API_DESCRIPTION = (
    "Inference + explainability service for the fine-tuned EfficientNetV2-B2 "
    "crop-disease classifier (72 classes across 15 crops), with a leaf "
    "segmentation + confidence + RAG-advisory safety pipeline. "
    "Use POST /predictdisease for the clean, app-ready response."
)
